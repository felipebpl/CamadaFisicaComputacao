...
def main():
    ...
    try:
        ...
        while ocioso:
            ...
            log_t1.write_log(t1_msg, "SERVER/logs/Server5.txt")
        ...
        log_t2.write_log(t2_msg, "SERVER/logs/Server5.txt")
        ...
        while c <= total_pkg:
            ...
            log_t3.write_log(t3_msg, "SERVER/logs/Server5.txt")
            ...
            if msg_type == 3:
                ...
                if eop == b'\xFF\xAA\xFF\xAA' and payload_id == c: 
                    ...
                    log_t4.write_log(t4_msg, "SERVER/logs/Server5.txt")
                    c += 1 
                    ...
                    log_t6.write_log(t6_msg, "SERVER/logs/Server5.txt")
                ...
                if time.time() - timer > 20:
                    ...
                    log_t5.write_log(t5_msg, "SERVER/logs/Server5.txt")
