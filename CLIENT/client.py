    ...
    try:
        ...
        if tipo == 1: 
            ...
            while HANDSHAKE:
                ...
                log_t1.write_log(t1_msg, "CLIENT/logs/Client5.txt")
                ...
                while time.time() < timeout:
                    ...
                    if pkg.com1.rx.getIsEmpty() != True:
                        ...
                        log_t2.write_log(t2_msg, "CLIENT/logs/Client5.txt")
        ...
        #para voltar a primeira situacao basta fazer a linha abaixo = False
        ...
        while cont <= total_pkg:   
            ...
            if test_wrong_order:
                ...
                log_t3_wrong.write_log(t3_wrong_msg, "CLIENT/logs/Client5.txt")
            ...
            log_t3.write_log(t3_msg, "CLIENT/logs/Client5.txt")
            ...
            log_t3_response.write_log(t3_response_msg, "CLIENT/logs/Client5.txt")
            ...
            if tipo_response == 4:
                ...
                if rxBuffer == "REENVIE":
                    ...
                    # while time.time() < timer_timeout:
                        ...
                        log_t5.write_log(t5_msg, "CLIENT/logs/Client5.txt")
                        ...
                        log_t6.write_log(t6_msg, "CLIENT/logs/Client5.txt")
                        timer1 = time.time()                            
